...
public interface LoanRepository extends JpaRepository<Loan, Long>{
	...
	@Query(value = "select l from Loan as l join l.book as b where b.isbn = :isbn or l.costumer =:constumer ")
	Page<Loan> findByBookIsbnOrCostumer(@Param("isbn") String isbn, @Param("constumer") String constumer, Pageable page);
